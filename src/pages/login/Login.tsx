...
const Login: React.FC = () => {
    const handleSubmit = (event: React.FormEvent<SignInFormElement>) => {
        ...
        // Validate the cookie or make an API call to check its validity if necessary
        // For now, let's assume the cookie is valid if it exists
        console.log("User authenticated. Redirecting to the main page...");
